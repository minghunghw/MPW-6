...
# SRAM module
vlog +notimingchecks -quiet -sv -work ${LIB_PATH} ${RTL_PATH}/../mem/RA1SHD.v       || goto error
...
vlog -quiet -sv -work ${LIB_PATH} +incdir+${RTL_PATH}/includes ${ASIC_DEFINES} ${CORE_DEFINES} ${RTL_PATH}/pulpino_core.sv       || goto error
vlog -quiet -sv -work ${LIB_PATH} +incdir+${RTL_PATH}/includes ${ASIC_DEFINES} ${CORE_DEFINES} ${RTL_PATH}/pulpino_mem.sv        || goto error
